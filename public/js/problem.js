/*1678707323,,JIT Construction: v1007097004,en_US*/
...
try {
                                ...
                                var h = function(b) {
                                    ...
                                    e.process = function() {
                                        ...
                                        c("CORSRequest").execute(b, "get", {
                                            ...
                                            a.$MessengerCheckboxWrapper5.should_use_new_domain = b.should_use_new_domain,
                                                a.$MessengerCheckboxWrapper1 = new (c("sdk.XFBML.MessengerCheckbox"))(a.$MessengerCheckboxWrapper2,a.$MessengerCheckboxWrapper3,a.$MessengerCheckboxWrapper4,a.$MessengerCheckboxWrapper5),
                                                a.$MessengerCheckboxWrapper1.subscribe("render", function() {
                                                    a.inform("render")
                                                }),
                                ...
                                var h = function(b) {
                                    ...
                                    e.process = function() {
                                        ...
                                        c("CORSRequest").execute(b, "get", {
                                            ...
                                            a.$MessengerMessageUsWrapper5.should_use_new_domain = b.should_use_new_domain,
                                                a.$MessengerMessageUsWrapper1 = new (c("sdk.XFBML.MessengerMessageUs"))(a.$MessengerMessageUsWrapper2,a.$MessengerMessageUsWrapper3,a.$MessengerMessageUsWrapper4,a.$MessengerMessageUsWrapper5),
                                ...
                                var h = function(b) {
                                    ...
                                    e.process = function() {
                                        ...
                                        c("CORSRequest").execute(b, "get", {
                                            ...
                                            a.$SendToMessengerWrapper5.should_use_new_domain = b.should_use_new_domain,
                                                a.$SendToMessengerWrapper1 = new (c("sdk.XFBML.SendToMessenger"))(a.$SendToMessengerWrapper2,a.$SendToMessengerWrapper3,a.$SendToMessengerWrapper4,a.$SendToMessengerWrapper5),
                                                a.$SendToMessengerWrapper1.subscribe("render", function() {
                                                    a.inform("render")
                                                }),
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "sdk.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1007097004","namespace":"FB","message":"' + e.message + '"}}');
